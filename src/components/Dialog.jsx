...
const Dialog = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center absolute top-0 left-0 w-full h-full z-10 bg-transparent backdrop-blur-sm">
      <div className="rounded-xl shadow-md mx-3 border bg-white ">
        <div className="rounded-t-xl flex flex-row justify-between p-3 border-b">
        ...
        <div className="rounded-b-xl flex flex-col p-3">{data}</div>
      </div>
    </div>
  );
};
